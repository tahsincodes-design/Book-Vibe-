...
const colors = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#23BE0A', '#59C6D2', '#FF4560', '#775DD0'];
...
const PagesToRead = () => {
  const { readList, isLoaded } = useBookContext();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 lg:px-8 my-10">
      <div className="bg-[#131313]/5 rounded-2xl py-8 text-center mb-10">
        <h1 className="text-3xl font-bold font-serif text-[#131313]">Pages to Read</h1>
      ...
      {chartData.length > 0 ? (
        <div className="bg-[#131313]/5 rounded-3xl p-6 sm:p-10 border border-gray-100">
          <div className="w-full h-96 sm:h-112.5">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis
                  ...
                  label={{ value: 'Pages', angle: -90, position: 'insideLeft', fill: '#777' }}
                />
                <Tooltip
                ...
                <Bar
                  dataKey="pages"
                  shape={<TriangleBar />}
                  label={{ position: 'top', fill: '#131313', fontSize: 13, fontWeight: 'bold' }}
                >
        ...
        <div className="text-center py-20 bg-gray-50 rounded-3xl border border-dashed border-gray-200 my-6">
          <div className="max-w-md mx-auto space-y-4">
            <h3 className="text-xl font-bold text-gray-800">No Data to Display</h3>
